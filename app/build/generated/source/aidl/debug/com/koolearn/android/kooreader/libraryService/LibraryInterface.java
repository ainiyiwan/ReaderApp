 ...
 * Original file: D:\\WorkDemo\\ReaderApp\\app\\src\\main\\aidl\\com\\koolearn\\android\\kooreader\\libraryService\\LibraryInterface.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.koolearn.android.kooreader.libraryService.LibraryInterface
{
private static final java.lang.String DESCRIPTOR = "com.koolearn.android.kooreader.libraryService.LibraryInterface";
...
/**
 * Cast an IBinder object into an com.koolearn.android.kooreader.libraryService.LibraryInterface interface,
 * generating a proxy if needed.
 */
public static com.koolearn.android.kooreader.libraryService.LibraryInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.koolearn.android.kooreader.libraryService.LibraryInterface))) {
return ((com.koolearn.android.kooreader.libraryService.LibraryInterface)iin);
}
return new com.koolearn.android.kooreader.libraryService.LibraryInterface.Stub.Proxy(obj);
}
...
long _arg0;
_arg0 = data.readLong();
com.koolearn.android.kooreader.libraryService.PositionWithTimestamp _result = this.getStoredPosition(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
long _arg0;
_arg0 = data.readLong();
com.koolearn.android.kooreader.libraryService.PositionWithTimestamp _arg1;
if ((0!=data.readInt())) {
_arg1 = com.koolearn.android.kooreader.libraryService.PositionWithTimestamp.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
private static class Proxy implements com.koolearn.android.kooreader.libraryService.LibraryInterface
{
...
@Override public com.koolearn.android.kooreader.libraryService.PositionWithTimestamp getStoredPosition(long bookId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.koolearn.android.kooreader.libraryService.PositionWithTimestamp _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.koolearn.android.kooreader.libraryService.PositionWithTimestamp.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public void storePosition(long bookId, com.koolearn.android.kooreader.libraryService.PositionWithTimestamp position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_recentlyAddedBooks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_recentlyOpenedBooks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_removeFromRecentlyOpened = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_canRemoveBook = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_formats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setActiveFormats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_deletedBookmarkUids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_purgeBookmarks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getDefaultHighlightingStyleId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_setDefaultHighlightingStyleId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
}
...
public com.koolearn.android.kooreader.libraryService.PositionWithTimestamp getStoredPosition(long bookId) throws android.os.RemoteException;
public void storePosition(long bookId, com.koolearn.android.kooreader.libraryService.PositionWithTimestamp position) throws android.os.RemoteException;
